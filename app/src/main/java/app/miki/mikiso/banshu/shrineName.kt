...
class shrineName : AppCompatActivity() {
    ...
    val shrineSata: List<ShrineSata> = listOf(
        ...
        ShrineSata("正八幡神社","体育の日前日・前々日"),
        ShrineSata("甲八幡神社","体育の日前日・前々日"),
        ShrineSata("津田天満神社","体育の日前日・前々日"),
        ShrineSata("中島天満宮","体育の日前日・前々日"),
        ShrineSata("高岳神社","体育の日前日・前々日"),
        ShrineSata("蒲田神社","体育の日前日・前々日"),
        ShrineSata("稲岡神社","体育の日前日・前々日"),
        ShrineSata("生矢神社","体育の日の前日・前々日"),
        ShrineSata("才天満神社","体育の日の前日・前々日"),
        ShrineSata("菅原神社","体育の日前日・前々日"),
